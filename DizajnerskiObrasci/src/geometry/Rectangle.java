...
public class Rectangle extends SurfaceShape {
	...
	public String toString() {
		return "Rectangle:UperLeftPoint->"+"(" + upperLeftPoint.getX() + "," + upperLeftPoint.getY() + ")" + " Height->" + height
				+ " Width->"+ " " + width +" "+ "EdgeColor("+ getColor().getRed()+","+ getColor().getGreen()+","+ getColor().getBlue()+")" + "InnerColor:("+ getInnerColor().getRed()+","+ getInnerColor().getGreen()+" "+ getInnerColor().getBlue()+")";
	}
