...
public class Line extends Shape {
	...
	public String toString() {
		return "Line:startpoint"+"("+startPoint.getX()+","+startPoint.getY()+")"+"endpoint"+"("+endPoint.getX()+","+endPoint.getY()+")" + "EdgeColor("+ getColor().getRed()+","+ getColor().getGreen()+","+ getColor().getBlue()+")";
	}
